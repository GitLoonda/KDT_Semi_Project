...
<script type="text/javascript">
	var app = new Vue({ 
		...
		data: {
			...
			cbno:opener.document.getElementById('scbno').value,
			sessionId:"${sessionId}",
			...
			fnbanin : function(){
				...
				if(self.report=="0"){
         	  	...
         	  	var nparmap = {cbno : self.cbno, id:self.id, brdflg:self.brdflg, bset:self.report, reconte:self.reconte};
				$.ajax({
